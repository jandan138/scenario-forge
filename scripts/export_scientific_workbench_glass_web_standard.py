#!/usr/bin/env python3
"""Export the six webpage-standard glass packages as one review ZIP."""
...
PACKAGES = [
    SOURCE_ROOT / "graduated_cylinder_250ml_glass_web_standard_v1",
...
OUTPUT_ROOT = (
    REPO_ROOT / "outputs/scientific_workbench_glass_web_standard_20260819/handoff"
)


def main() -> int:
    archive = build_asset_handoff_archive(
        archive_id="scientific_workbench_glass_web_standard",
        packages=PACKAGES,
