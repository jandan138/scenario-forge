#!/usr/bin/env python3
"""Generate Task 11 r9.2 with world-X opposed rotor tubes."""
...
PRIMARY_SOCKET = 0
BALANCE_SOCKET = 12
DEFAULT_OUT = ROOT / "outputs/scientific_workbench_task11_vr_r9_2_left_right_20260827"
...
def build(output: Path) -> Path:
    ...
    manifest["layout_revision"] = "world_x_left_right_pair"
    manifest["claims"].update(
        {
            "left_right_camera_pair": True,
            "world_x_left_right_pair": True,
