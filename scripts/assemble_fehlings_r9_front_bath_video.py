"""Assemble r9 in-bath MP4 from front_bath replay frames; tube stays in the water."""
import json
...
PACKAGE = ROOT / 'outputs/scientific_workbench_fehlings_reducing_sugar_water_bath_vr_r9_20260914/handoff/scientific_workbench_fehlings_reducing_sugar_water_bath_vr_r9'
SCENE = PACKAGE / 'evidence/initial_scene'
OUT_DIR = ROOT / 'outputs/scientific_workbench_fehlings_reducing_sugar_water_bath_vr_r9_20260914/video'
OUT_MP4 = ROOT / 'outputs/scientific_workbench_fehlings_reducing_sugar_water_bath_vr_r9_20260914/r9_front_bath.mp4'
...
def main():
    ...
    header = 'Fehling r9 | 正对隔杯 | tube stays in bath | 8 mL | prescribed-fixture replay'
    concat_lines = []
